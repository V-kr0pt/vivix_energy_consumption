...
class LoadData:
    def __init__(self, path='content/potencias_geral.xlsx'):
        ...
        self.boolean_features = []  # Boolean columns
        self.categorical_features = ['year', 'month', 'week_day', 'hour', 'day']  # Categorical columns
        self.numerical_features = []  # Numerical columns
